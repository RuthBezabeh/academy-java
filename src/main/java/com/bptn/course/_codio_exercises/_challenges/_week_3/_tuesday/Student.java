...
class Student {
    ...
    public void editStudent(List<Student> universityStudents, Student student) {
       ...
       //my understanding of why a student with a given id needs to replaced 
       //with a different student is if the previous student no longer goes to the 
       //university. hence the editStudent method could be put in the university  class
